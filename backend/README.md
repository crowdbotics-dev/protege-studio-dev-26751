...
## Project Structure
    ...
    ├── protege_studio_dev_26751  # Django project configurations
...
1. Clone this repo and `cd protege_studio_dev_26751`
...
2. Clone this repo and `cd protege_studio_dev_26751`
