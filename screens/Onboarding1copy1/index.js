...
const Untitled1 = ({
  ...
  return <View style={{
    ...
    height: "100%"
      ...
      fontSize: 14,
      borderRadius: 0
    }}>Skip</Text><ImageBackground source={{
      ...
      width: 170,
      height: 143
    }}></ImageBackground><Pressable onPress={() => navigation.navigate("  Onboarding2Copy1")}><View style={{
        position: "absolute",
        left: 8,
        top: 271,
        height: 42,
      ...
      borderRadius: 0,
      fontWeight: 700
    }}>How Does it Works?</Text><Text style={{
      position: "absolute",
      left: 33,
      top: 222,
      width: 131,
      ...
      fontSize: 14,
      borderRadius: 0
    }}>Sed ut perspiciatis unde omnis iste natus error sit omnis 
    </Text></View>;
};
